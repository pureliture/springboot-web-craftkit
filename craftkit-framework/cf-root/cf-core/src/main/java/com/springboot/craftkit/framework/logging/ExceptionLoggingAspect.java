package com.springboot.craftkit.framework.logging;
...
public class ExceptionLoggingAspect {
    ...
    @Pointcut("within(@" +
            "com.springboot.craftkit.framework.application.annotation.AutoLogging" +
            " *)")
    public void autoLoggingOnType() {}

    @Pointcut("@annotation(com.springboot.craftkit.framework.application.annotation.AutoLogging)")
